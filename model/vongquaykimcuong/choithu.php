...
// 4 - ko đủ tiền
	...
	require $_SERVER['DOCUMENT_ROOT'].'/lib/BiasedRandom/Randomizer.php';
	  ...
	  $randomizer          ->add( new Element('1', $kun->vongquaykimcuong_gift($id, 1, 'tyletest'))) 
	                       ->add( new Element('2', $kun->vongquaykimcuong_gift($id, 2, 'tyletest'))) 
	                       ->add( new Element('3', $kun->vongquaykimcuong_gift($id, 3, 'tyletest')))
	                       ->add( new Element('4', $kun->vongquaykimcuong_gift($id, 4, 'tyletest'))) 
	                       ->add( new Element('5', $kun->vongquaykimcuong_gift($id, 5, 'tyletest')))
	                       ->add( new Element('6', $kun->vongquaykimcuong_gift($id, 6, 'tyletest'))) 
	                       ->add( new Element('7', $kun->vongquaykimcuong_gift($id, 7, 'tyletest'))) 
	                       ->add( new Element('8', $kun->vongquaykimcuong_gift($id, 8, 'tyletest'))) 
	                          ;
