...
$id = $_POST['id'];
$row = mysqli_fetch_assoc(mysqli_query($kun->connect_db(), "SELECT * FROM `kimcuong` WHERE `id`='".$id."'"));
?>
...
<div class="modal-footer">
            <button id="mua" type="submit" class="btn c-theme-btn c-btn-border-2x c-btn-square c-btn-bold c-btn-uppercase btn-buy" Onclick="muahomthinh('<?php echo $row['id'];?>')">Mua ngay</button>
...
$.ajax({
                method: "POST",
                url: "/model/game/kimcuong/xuly.php",
                data: {
                    id: id
                },
