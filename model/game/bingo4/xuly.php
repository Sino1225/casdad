...
if($vongquay == 1){
    $gift = "Bạn Nhận được 120 Kim Cương"; 
    $kimcuong = 120;
}elseif($vongquay == 2){
    $gift = "Bạn Nhận được 300 Kim Cương";
    $kimcuong = 300;
}elseif($vongquay == 3){
    $gift = "Bạn Nhận được 500 Kim Cương";
    $kimcuong = 500;
}elseif($vongquay == 4){
    $gift = "Bạn Nhận được 2.000 Kim Cương";
    $kimcuong = 2000;
}elseif($vongquay == 5){
    $gift = "Bạn Nhận được 9.999 Kim Cương";
    $kimcuong = 9999;
}elseif($vongquay == 6){
