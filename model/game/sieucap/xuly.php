...
switch ($kundeptrai) {
    ...
    case '2':
        ...
        break;
    case '3':
        $gift = '<font color="black">Chúc Mừng! Bạn nhận được 2999 Kim Cương</font>';
        $location = '2999 Kim Cương';
        $kc = '2999';    
        break;
    case '4':
        $gift = '<font color="black">Chúc Mừng! Bạn nhận được 9999 Kim Cương</font>';
        $location = '21536';
        $kc = '9999';   
        break;
