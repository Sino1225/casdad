...
switch ($kundeptrai) {
    case '1':
    $vongquay = 1;
    $img = '/assets/img/latthe/1.png'; // chúc may mắn lần sau nữa
        break;
    case '2':
    $vongquay = 2;
    $img = '/assets/img/latthe/2.png';      // 10 kc
        break;
    case '3':
    $vongquay = 3;
    $img = '/assets/img/latthe/3.png';      // 5000 kc
        break;
    case '4':
    $vongquay = 4;
    $img = '/assets/img/latthe/4.png';    // 50 kc
        break;
    case '5':
    $vongquay = 5;
    $img = '/assets/img/latthe/5.png';   // 9999 kc
        break;
    case '6':
    $vongquay = 6;
    $img = '/assets/img/latthe/6.png';    // 500 kc
        break;
    case '7':
    $vongquay = 7;
    $img = '/assets/img/latthe/7.png';    // 500 kc
        break;
    case '8':
    $vongquay = 8;
    ...
    case '9':
    $vongquay = 9;
    $img = '/assets/img/latthe/9.png';    // 500 kc
        break;
