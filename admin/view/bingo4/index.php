...
<h2><b>CHỈNH SỬA TỈ LỆ BINGO TẾT TRUNG THU</b></h2><br>
    ...
    <div class="row">
                    ...
                    <div class="col-sm-12 col-md-2 col-lg-2">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">120 Kim Cương</h4>
                    ...
                    <div class="col-sm-12 col-md-2 col-lg-2">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">300 Kim Cương</h4>
                                    <div class="form-group">
                    ...
                    <div class="col-sm-12 col-md-2 col-lg-2">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">500 Kim Cương</h4>
                                    <div class="form-group">
