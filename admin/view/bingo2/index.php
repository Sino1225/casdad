...
<?php
    ...
    $_bingo = mysqli_fetch_assoc(mysqli_query($kun->connect_db(), "SELECT * FROM `setting_bingo2`"));
...
<h2><b>CHỈNH SỬA TỈ LỆ BINGO SIÊU CẤP</b></h2><br>
    ...
    <div class="row">
                    ...
                    <div class="col-sm-12 col-md-2 col-lg-2">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">20 Kim Cương</h4>
                    ...
                    <div class="col-sm-12 col-md-2 col-lg-2">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">50 Kim Cương</h4>
                                    <div class="form-group">
                    ...
                    <div class="col-sm-12 col-md-2 col-lg-2">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">225 Kim Cương</h4>
                                    <div class="form-group">
  ...
  <div class="col-sm-12 col-md-2 col-lg-2">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">5000 Kim Cương</h4>
                                    <div class="form-group">
                    ...
                    <div class="col-sm-12 col-md-2 col-lg-2">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">9999 Kim Cương</h4>
                                    <div class="form-group">
