...
if(isset($_POST['congtienpost'])) {
	if(isset($_POST['id_user'])) {
		mysqli_query($kun->connect_db(), "UPDATE `users` SET `money` = '".$_POST['money']."', `kimcuong`='".$_POST['kimcuong']."', `tile`='".$_POST['tile']."' WHERE `id` = '".$_POST['id_user']."'");
		...
		?>
              ...
              <div class="card">
                        ...
                        <div class="body">
                          ...
                          <div class="col-lg-3 col-sm-12 col-md-4">
	                                <label for="username">Tỷ Lệ Quay Kim Cương Cao</label>
		                                <div class="form-group">
		                                    <div class="form-group">
		                                        <input name="tile" type="text" class="form-control" value="<?php echo $current_user['tile'];?>" required>
		                                    </div>
		                                </div>
								          </div>
