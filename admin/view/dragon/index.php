...
<?php
    ...
    $_bingo = mysqli_fetch_assoc(mysqli_query($kun->connect_db(), "SELECT * FROM `setting_dragon`"));
...
<h2><b>CHỈNH SỬA TỈ LỆ GỌI RỒNG 18K</b></h2><br>
  ...
  <div class="col-sm-12 col-md-2 col-lg-2">
                    ...
                    <div class="col-sm-12 col-md-2 col-lg-2">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">6999 Kim Cương</h4>
                                    <div class="form-group">
                    ...
                    <div class="col-sm-12 col-md-2 col-lg-2">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">14999 Kim Cương</h4>
                                    <div class="form-group">
