...
<div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h3 class="card-title"><b>CHỈNH SỬA TỈ LỆ LẬT BÀI</b></h3>

<div class="row">

                                            <div class="col-md-2 col-lg-2 col-xs-12">
                                                <label>29 Kim Cương</label>
