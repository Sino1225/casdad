...
<?php
    ...
    $_bingo = mysqli_fetch_assoc(mysqli_query($kun->connect_db(), "SELECT * FROM `setting_try`"));
...
<h2><b>TỈ LỆ CHƠI THỬ CỦA BINGO</b></h2><br>
    ...
    <div class="row">
                    ...
                    <div class="col-sm-12 col-md-2 col-lg-2">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">25 Kim Cương</h4>
  ...
  <div class="col-sm-12 col-md-2 col-lg-2">
                    ...
                    <div class="col-sm-12 col-md-2 col-lg-2">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">7000 Kim Cương</h4>
                                    <div class="form-group">
