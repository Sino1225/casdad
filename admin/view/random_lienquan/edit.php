...
if(isset($_POST['sua_goi'])) {
	...
	mysqli_query($kun->connect_db(), "UPDATE `random_lienquan` SET `name`='".$_POST['name']."', `giatien`='".$_POST['giatien']."', `mota`='".$_POST['mota']."', `thumb`='".$_POST['thumb']."' WHERE `id`='".$_POST['id']."'");
...
<div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h3 class="card-title">SỬA GÓI RANDOM LIÊN QUÂN "<b><?php echo $row['name'];?></b>"</h3>
