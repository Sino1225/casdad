...
if(isset($_POST['them_goi'])) {
	...
	mysqli_query($kun->connect_db(), "INSERT INTO `random_lienquan` (`name`, `cname`, `thumb`, `giatien`, `mota`, `status`, `time`) VALUES ('".$_POST['name']."', '".$_POST['cname']."', '".$_POST['thumb']."', '".$_POST['giatien']."', '".$_POST['mota']."', 'false', '".time()."')");
...
<div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h3 class="card-title">THÊM GÓI RANDOM LIÊN QUÂN</h3>
...
<div class="card">
                            <div class="card-body">
                                <h4 class="card-title">DANH SÁCH GÓI RANDOM LIÊN QUÂN</h4>
                            </div>
    ...
    <?php
        ...
        <tr>
           ...
           <td><?php echo mysqli_num_rows(mysqli_query($kun->connect_db(), "SELECT * FROM `random_lienquan_nick` WHERE `cname`='".$row['cname']."' AND `status`='true'")) ;?></td>
           <td><?php echo mysqli_num_rows(mysqli_query($kun->connect_db(), "SELECT * FROM `random_lienquan_nick` WHERE `cname`='".$row['cname']."' AND `status`='false'")) ;?></sup></td>
           <td><?php echo number_format($row['giatien']);?> <sup>vnđ</sup></td>
           <td><?php echo date('H:i d/m', $row['time']);?></td>
        <td>
           <a href="?modun=random_lienquan&act=edit&id=<?php echo $row['id'];?>">
