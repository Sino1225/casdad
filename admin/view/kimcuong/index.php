...
echo '<div class="alert alert-success fade in alert-dismissible">
    ...
    <strong>Success!</strong> Đăng bán Rút Kim Cương thành công
</div>';
...
<div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h3 class="card-title">Đăng Bán Rút Kim Cương </h3>
...
<div class="row">
                                            ...
                                            <div class="col-md-4 col-lg-4 col-xs-12">
                                                ...
                                                <div class="form-group">
                                                     <input name="kimcuong" type="text" class="form-control" placeholder="Nhập Số Kim Cương Xuất Hiện Trong Rút Kim Cương">
                                                </div>
                                            </div>
                            ...
                            <div class="col-md-12"> 
                                <center><button type="submit" name="submit" class="btn btn-info">ĐĂNG BÁN Rút Kim Cương</button></center>
                            </div>
