    ...
    <input type="hidden" name="type" value="KC2">
            ...
            <div class="container"  style="    background-color: rgba(0,0,0,0.8); margin-bottom:15px">
                  ...
                  <div class="c-content-title-4">
              					<h3 class="c-font-uppercase c-center c-font-bold c-line-strike"><span class="c-bg-grey-1">Shop Bán Acc KC2 - Bán Acc KC2 Giá Rẻ, Uy Tín Hàng Đầu Việt Nam </span></h3>
              				</div>
