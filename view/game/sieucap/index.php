...
<meta name="csrf-token" content="77wVCLxZF77menKFUczTRqFMB8D8zTNSEJQ4ym6t">
 <div class="container content-black">
    <div class="c-content-title-1 pd50">
        <h3 class="c-center c-font-uppercase c-font-bold">Vòng Quay Quái Vật Đại Dương</h3>
...
<table id="squaredesktop" class="square">
                        <tbody><tr>
                            <td></td>
                            <td><div id="id21525" data-num="1" class="gift1 box"><img src="/assets/img/quai_vatdaiduong/19.png"></div></td>
                            <td><div id="id21526" data-num="2" class="gift2 box"><img src="/assets/img/quai_vatdaiduong/99.png"></div></td>
                            <td><div id="id21527" data-num="3" class="gift3 box"><img src="/assets/img/quai_vatdaiduong/399.png"></div></td>
                            <td></td>
                        </tr>
                        <tr>
                            <td><div id="id21538" data-num="12" class="gift12 box"><img src="/assets/img/quai_vatdaiduong/19999.png"></div></td>
                            <td colspan="3"></td>
                            <td><div id="id21528" data-num="4" class="gift4 box"><img src="/assets/img/quai_vatdaiduong/599.png"></div></td>
                        </tr>
                        <tr>
                            <td><div id="id21537" data-num="11" class="gift11 box"><img src="/assets/img/quai_vatdaiduong/14999.png"></div></td>
                            <td colspan="3">
                                <div class="outer-btn">
                                <div class="play" style="display: block; margin: 0 auto; width: 80%;position: relative;z-index: 1;">
                                    <img src="/assets/img/quai_vatdaiduong/play.png" alt="" style="position: absolute;top: 0px;left: 17%;width:70%">
                                </div>
                                </div>
                            </td>
                            <td><div id="id21529" data-num="5" class="gift5 box"><img src="/assets/img/quai_vatdaiduong/999.png"></div></td>
                        </tr>
                        <tr>
                            <td><div id="id21536" data-num="10" class="gift10 box"><img src="/assets/img/quai_vatdaiduong/9999.png"></div></td>
                            <td colspan="3"></td>
                            <td><div id="id21530" data-num="6" class="gift6 box"><img src="/assets/img/quai_vatdaiduong/1500.png"></div></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td><div id="id21535" data-num="9" class="gift9 box"><img src="/assets/img/quai_vatdaiduong/6999.png"></div></td>
                            <td><div id="id21533" data-num="8" class="gift8 box"><img src="https://imgur.com/ATwEeX9.png"></div></td>
                            <td><div id="id21531" data-num="7" class="gift7 box"><img src="https://imgur.com/ZTwb8Zc.png"></div></td>
                            <td></td>
                        </tr>
                    </tbody></table>
...
<div class="col-lg-3 col-md-12 col-sm-12 btn-right">
    ...
    <div class="text-center">           
                            <h3 class="num-play" style="color:white">Bạn còn <span><span><?php echo number_format($user['kimcuong']);?></span> Kim Cương.</h3>
...
<p><strong><font color="black">VÒNG QUAY QUÁI VẬT ĐẠI DƯƠNG</font></strong></p>
<p><strong><font color="black">Mỗi lượt quay <?php echo $kun->compact_number($ros['giatien']);?> có cơ hội nhận từ 100kc- 15000kc&nbsp;</font></strong></p>
</div>
...
<tbody>
<?php 
$res = mysqli_query($kun->connect_db(), "SELECT * FROM `user_history_system` WHERE `action`='VÒNG QUAY GIẢI CỨU' AND `action_name`='VÒNG QUAY GIẢI CỨU' ORDER BY `time` DESC LIMIT 0, 50");
...
<div class="modal-body content-popup" style="font-family: helvetica, arial, sans-serif;">VÒNG QUAY QUÁI VẬT ĐẠI DƯƠNG <?php echo $kun->compact_number($ros['giatien']);?></div>
<div class="modal-footer">
<button type="button" class="btn c-theme-btn c-btn-border-2x c-btn-square c-btn-bold c-btn-uppercase" data-dismiss="modal">Đóng</button>
</div>
</div>
