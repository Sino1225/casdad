<?php 
$ros = mysqli_fetch_assoc(mysqli_query($kun->connect_db(), "SELECT * FROM `setting_dragon`"));
?>
<style>
...
<div class="c-content-title-1 pd50">
    <h3 class="c-center c-font-uppercase c-font-bold" style="color:white">TRIỆU HỒI RỒNG THẦN</h3>
            ...
            <div class="c-content-client-logos-slider-1  c-bordered" data-slider="owl">
                      <section class="rotation" style="position:relative;z-index:1">
                        <div class="play-spin" style="position:relative;z-index:1">
							<div class="bgnen"></div>  
                            <img style="width: 100%;max-width: 100%;opacity: 1;background: url(/img/trochoi/dragon/khung.png) no-repeat center center;background-size: contain;" src="/img/trochoi/dragon/rong.gif" alt="Play" id="img">  
                        </div>
                    ...
                    <select  name="x" id="x" class="form-control" style="width:66%;margin: auto;padding:5px 10px;border: 1px solid #144ed7;">
                                                <option value="1">Triệu Hôi X1 - <?php echo number_format($ros['giatien']);?> VNĐ/ 1 Lần</option>
                                                <option value="2">Triệu Hôi X2 - <?php echo number_format($ros['giatien'] * 2);?> VNĐ/ 1 Lần</option>
                                                <option value="3">Triệu Hôi X5 - <?php echo number_format($ros['giatien'] * 5);?> VNĐ/ 1 Lần</option>
                                                <option value="4">Triệu Hôi X10 - <?php echo number_format($ros['giatien'] * 10);?> VNĐ/ 1 Lần </option>
                    ...
                    <br>
							<div class="ptry">
                                <a id="start">
                                    <img style=" cursor: pointer;" src="https://quanlyshop.vip/upload/settings/16243603749995274.png">
                                </a>
...
<script type="text/javascript">
	$(document).ready(function() {
		$('#start').click(function() {
			$('#img').attr('src', '/img/trochoi/dragon/rong_random_kc.gif');
            
		    setTimeout(function(){
				$.ajax({ 
			        type: 'post', 
			        dataType: "JSON",
			        url: '/model/game/dragon/xuly.php', 
			        data: {
			        	type: 'play',
			        	x: $("#x").val()
			        }, 
			        success: function (json) {
			          ...
			          if(json.status == 3) {
                        ...
                        return;
                        $('#img').attr('src', '/img/trochoi/dragon/rồng-đóng.gif');
