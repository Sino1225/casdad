...
<div class="c-content-title-1 pd50">
    <h3 class="c-center c-font-uppercase c-font-bold" style="color:white">Kho Báu Hùng Vương</h3>
            ...
            <div class="c-content-client-logos-slider-1  c-bordered" data-slider="owl">
                      <section class="rotation" style="position:relative;z-index:1">
                        <div class="play-spin" style="position:relative;z-index:1">
							<div class="bgnen"></div>  
                            <img style="width: 100%;max-width: 100%;opacity: 1;background: url(https://i.imgur.com/h2DYNf8.png) no-repeat center center;background-size: contain;" src="https://i.imgur.com/UqHb2TK.gif" alt="Play" id="img">  
                        </div>

						<div class="text-center">           
							<h3 class="num-play" style="color: red;">Giá <span>27,000</span>/lượt chơi.</h3>
						</div>
							<div class="ptry">
                                <a id="start">
...
<script type="text/javascript">
	$(document).ready(function() {
		$('#start').click(function() {
			$('#img').attr('src', 'https://i.imgur.com/qGhoLJs.gif');
            
		    setTimeout(function(){
				$.ajax({ 
			        type: 'post', 
			        dataType: "JSON",
			        url: '/model/game/rongthan/xuly.php', 
			        data: {
			        	type: 'play'
			        }, 
                    ...
                    $('#noticeModal').modal('show');      
                        $('#img').attr('src', 'https://i.imgur.com/UqHb2TK.gif');
