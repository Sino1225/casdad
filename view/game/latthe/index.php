                      ...
                      <section class="rotation">
                        <div class="col-lg-12 boxflip" id="okmain">                          
                                    <div class="col-lg-4 col-md-3 col-sm-4 col-xs-6" id="gift1">
                                                <img id="img1" class="" src="/assets/img/latthe/1.png">
                                                <img onclick="umbalaxibua('gift1', 'imgnen1')" id="imgnen1" class="shake-image" src="/assets/img/latthe/card_up.jpg">
                                    </div>

                                    <div class="col-lg-4 col-md-3 col-sm-4 col-xs-6" id="gift2">
                                                <img id="img2" class="" src="/assets/img/latthe/2.png">
                                                <img onclick="umbalaxibua('gift2', 'imgnen2')" id="imgnen2" class="shake-image" src="/assets/img/latthe/card_up.jpg">
                                    </div>

                                    <div class="col-lg-4 col-md-3 col-sm-4 col-xs-6" id="gift3">
                                                <img id="img3" class="" src="/assets/img/latthe/3.png">
                                                <img onclick="umbalaxibua('gift3', 'imgnen3')" id="imgnen3" class="shake-image" src="/assets/img/latthe/card_up.jpg">
                                    </div>

                                    <div class="col-lg-4 col-md-3 col-sm-4 col-xs-6" id="gift4">
                                                <img id="img4" class="" src="/assets/img/latthe/4.png">
                                                <img onclick="umbalaxibua('gift4', 'imgnen4')" id="imgnen4" class="shake-image" src="/assets/img/latthe/card_up.jpg">
                                    </div>

                                    <div class="col-lg-4 col-md-3 col-sm-4 col-xs-6" id="gift5">
                                                <img id="img5" class="" src="/assets/img/latthe/5.png">
                                                <img onclick="umbalaxibua('gift5', 'imgnen5')" id="imgnen5" class="shake-image" src="/assets/img/latthe/card_up.jpg">
                                    </div>

                                    <div class="col-lg-4 col-md-3 col-sm-4 col-xs-6" id="gift6">
                                                <img id="img6" class="" src="/assets/img/latthe/6.png">
                                                <img onclick="umbalaxibua('gift6', 'imgnen6')" id="imgnen6" class="shake-image" src="/assets/img/latthe/card_up.jpg">
                                    </div>
                                    <!-- 7 -->
                                    <div class="col-lg-4 col-md-3 col-sm-4 col-xs-6" id="gift7">
                                                <img id="img7" class="" src="/assets/img/latthe/7.png">
                                                <img onclick="umbalaxibua('gift7', 'imgnen7')" id="imgnen7" class="shake-image" src="/assets/img/latthe/card_up.jpg">
                                    </div>
                                    
                                    <!-- 8 -->
                                    <div class="col-lg-4 col-md-3 col-sm-4 col-xs-6" id="gift8">
                                                <img id="img8" class="" src="/assets/img/latthe/8.png">
                                                <img onclick="umbalaxibua('gift8', 'imgnen8')" id="imgnen8" class="shake-image" src="/assets/img/latthe/card_up.jpg">
                                    </div>
                                    
                                    <!-- 9 -->
                                    <div class="col-lg-4 col-md-3 col-sm-4 col-xs-6" id="gift9">
                                                <img id="img9" class="" src="/assets/img/latthe/9.png">
                                                <img onclick="umbalaxibua('gift9', 'imgnen9')" id="imgnen9" class="shake-image" src="/assets/img/latthe/card_up.jpg">
                                    </div>
                          </div>
                        ...
                        <div class="col-sm-12 btn-right">
                            <button style="cursor: pointer; " id="chehinh" class="play col-xs-12 btn btn-success m-btn m-btn--custom m-btn--icon m-btn--pill" >
                                <span>
                        ...
                        <div class="col-sm-12 btn-right" style="cursor: pointer; display: none;">
                            <a class="continue col-xs-12 btn btn-success m-btn m-btn--custom m-btn--icon m-btn--pill">
                                <span>
                                    <i class="la la-cloud-upload"></i>
                                    <span>Chơi tiếp</span>
                                </span>
            ...
            <div class="modal-body" style="font-family: helvetica, arial, sans-serif;">
                ...
                <div class="list-roll-inner">
                    ...
                    <table cellpadding="10" class="table table-striped">
                        ...
                        <tbody>
                            <?php 
$res = mysqli_query($kun->connect_db(), "SELECT * FROM `user_history_system` WHERE `action`='Lật Bài Siêu Nhân Gao' AND `action_name`='Lật Bài Siêu Nhân Gao' ORDER BY `time` DESC LIMIT 0, 50");
...
<script type="text/javascript">
    ...
    function umbalaxibua(selector, card) {
        ...
        roll.src = "";
        roll.src = '/assets/img/latthe/card_up.jpg';
