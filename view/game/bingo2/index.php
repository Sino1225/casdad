...
@media    screen and (max-width: 580px) {
	...
	.game-list {
        ...
        background: url(/img/trochoi/bingo_sieucap/khung.png) no-repeat;
    ...
    #slot3 {
        ...
        .a2 {
        background-image: url("/img/trochoi/bingo_sieucap/a2.png");
    }
        .a3 {
        background-image: url("/img/trochoi/bingo_sieucap/a3.png");
    }
        .a4 {
        background-image: url("/img/trochoi/bingo_sieucap/a4.png");
    }
        .a5 {
        background-image: url("/img/trochoi/bingo_sieucap/a5.png");
    }
        .a6 {
        background-image: url("/img/trochoi/bingo_sieucap/a6.png");
    }
        .a7 {
        background-image: url("/img/trochoi/bingo_sieucap/a7.png");
    }
...
<div class="c-content-title-1 pd50">
    <h3 class="c-center c-font-uppercase c-font-bold" style="color:white">Bingo CHIẾN BINH TỐI THƯỢNG</h3>
...
<div id="boxfull" class="col-lg-7 col-md-12">
    ...
    <main>
                ...
                <section id="Slots">
                    <div id="slot1" class="a1"><img id="role_1" src="/img/trochoi/bingo_sieucap/1620758229646196.png"></div>
                    <div id="slot2" class="a1"><img id="role_2" src="/img/trochoi/bingo_sieucap/1620758229646196.png"></div>
                    <div id="slot3" class="a1"><img id="role_3" src="/img/trochoi/bingo_sieucap/1620758229646196.png"></div>
                </section>
                  <section id="Gira"
           ...
           <div class='clearfix'></div>
               <section class="dropdownlist">
                ...
                <div  style="text-align: center; margin-top: 115px;">
                    <a class="sl-btnod hover-btn" style="background: url(https://quanlyshop.vip/upload/settings/162092238068630790.png); background-size: 136px 36px;" id="try"></a>
                </div>
            </div>
        </div>
    </div>
...
<div class="col-lg-3 col-md-12 col-sm-12 btn-right">
    ...
    <div class="text-center">           
                            <h3 class="num-play" style="color:white">Bạn còn <span><?php echo number_format($user['kimcuong']);?></span> Kim Cương.</h3>
                                          <li><a style="" class="ani-zoom btn-img deposit-btn disabled" href="/nap-the" ><img src="https://shopchinhthuc.vn/mualuot.png" alt=""></a></li>
...
setTimeout( function show_ketqua(){
     swal("Kết Quả Chơi Thật", msg, "success"); 
         document.getElementById("Gira").disabled = false;
         reload_money();
 }, 3200 );
