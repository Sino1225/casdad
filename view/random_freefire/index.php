...
<form id="vl" class="form-inline m-b-10" role="form">
    ...
    <input type="hidden" name="type" value="FF100K">
            ...
            <div class="container"  style="    background-color: rgba(0,0,0,0.8); margin-bottom:15px">
                  ...
                  <div class="c-content-title-4">
              					<h3 class="c-font-uppercase c-center c-font-bold c-line-strike"><span class="c-bg-grey-1">Shop Bán Acc FF100K - Bán Acc FF100K Giá Rẻ, Uy Tín Hàng Đầu Việt Nam </span></h3>
              				</div>
    ...
    <div class="classWithPad">
        ...
        <div class="attribute_info">
            <div class="row">
                						...
                						<div class="col-xs-6 a_att"> Loại Nick <span class="c-font-red">  Random</span></div>
						<div class="col-xs-6 a_att"> Tỉ Lệ <span class="c-font-red">  Ngẫu Nhiên</span></div>



						
                        						<div class="col-xs-6 a_att"> Đăng kí Facebook <span class="c-font-red">Có</span></div>
						
						
						                                    
                                                                      
                                  
                                                                        <div class="col-xs-6 a_att"> Phần thưởng : <span class="c-font-red">Nick </span></div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body" style="font-family: helvetica, arial, sans-serif; color:black">
                    ...
                    <p>Thử Vận May Free Fire

Tất Cả Tài Khoản Đăng Nhập Bằng Facebook

Chú ý gỡ bỏ tất cả tài khoản trên ứng dụng Facebook sau đó đăng nhập nick bằng mạng 3G 4G để hạn chế bị xác minh danh tính</p>                </div>
