...
<div class="row">
			<div class="col-md-4 col-xs-6 wow animate fadeInLeft" style="opacity: 1; visibility: visible; animation-name: fadeInLeft;">
				<div class="c-content-step-1 c-opt-1">
					...
					<div class="c-title c-font-20 c-font-bold c-font-uppercase">Freefire</div>
...
<div class="m-t-20">
    ...
    <div class="text-center">
        <b class="c-font-20">Hình ảnh chi tiết của tài khoản <span class="c-font-red">Freefire #<?=$getdv['id']?></span></b>
    <br>
    <br>
    <div class="c-content-title-2">
    		<div class="c-line c-dot c-theme-bg c-theme-bg-after"></div>
        ...
        $dir = $path.'info/'.$id;
                  ...
                  if ($opendirectory = opendir($dir)){
                    while (($file = readdir($opendirectory)) !== false){
                        ...
                        if ($file != "." && $file != "..") {
                        echo '<a href="/upload/nickff/info/'.$id.'/'.$file.'"><img src="/upload/nickff/info/'.$id.'/'.$file.'" class="img-responsive img-thumbnail"></a>';
        				}
                  	}
